...
// dotnet run -- -file wordle-words.txt -wordLength 5 -validLetters "IK" -invalidLetters "WHALEDRN" -constraints "I3+K5-S1+K2-P4-S5-"
// dotnet run -- -file wordle-words.txt -wordLength 5 -invalidLetters "WHALEDRN" -constraints "I3+K5-S1+K2-P4-S5-"
// dotnet run -- -file words.txt -wordLength 6 -invalidLetters "wtioaghlcb" -constraints "s1-r2-n4-u4+e5-r6-s6-"
// dotnet run -- -c a1-o3-s4- -i reunity
/*
...
First 10 burn words: - Ideal would be blips
jowpy: 7
podgy: 7
gowdy: 6
wodgy: 6
